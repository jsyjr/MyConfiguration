...
hi = len(logs)-1
lo = 0
if logs[lo].contains(searchStr):
    print 'The search term was in the file all the way from the beginning of time %s' % logs[lo].rev
    sys.exit(0)
...
print 'Search term was introduced in rev %s' % logs[hi].rev
